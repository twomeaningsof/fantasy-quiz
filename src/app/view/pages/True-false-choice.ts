...
export class TrueFalseQuestionPage {
  ...
  private createQuestions() {
    ...
    const trueFalseButtonOne = Button.trueFalse('answer-true').withText('True').onClick(() => this.trueFalseChoice("true"));
    const trueFalseButtonTwo = Button.trueFalse('answer-false').withText('False').onClick(() => this.trueFalseChoice("false"));
  ...
  private createConfirm(){
    ...
    const questionPageConfirmButton: Button = Button.bolded('confirm-button').withText('Confirm').onClick(this.handleChangeToSummary);
